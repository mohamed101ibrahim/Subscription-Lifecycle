...
class Subscription extends Model
{
    ...
    /**
     * Get the billing cycle this subscription uses (derived from price)
     */
    public function billingCycle()
    {
        return $this->hasOneThrough(
            PlanBillingCycle::class,
            PlanPrice::class,
            'id',                    // plan_prices.id
            'id',                    // plan_billing_cycles.id
            'plan_price_id',         // subscriptions.plan_price_id
            'plan_billing_cycle_id'  // plan_prices.plan_billing_cycle_id
        );
    }

    /**
     * Accessor for billing_cycle to maintain compatibility
     */
